...
1. `# [Icon] Assignment: [Assignment Title]`
2. `## [Icon] Objective`
3. `## [Icon] Tasks`
4. For each task:
   - `### [Icon] [Task Name]`
...
- Keep language clear, encouraging, and student-friendly.
- Keep requirements learning-focused and aligned to explicit skills.
- Prefer concrete and testable outcomes over vague goals.
